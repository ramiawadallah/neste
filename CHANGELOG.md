...
_Mar 3 2015_
* enhancements
  - Add support for Laravel 5.x, leave a [1.0.x](https://github.com/etrepat/neste/tree/1.0.x-stable) branch for backwards compatibility.
...
* bug fixes
  - Full support for PHP >= 5.3.7. Neste should work if Eloquent works.

## 1.0.3
_July 5th 2013_

* enhanments
  - Add support for PHP 5.3 to make Neste match the requirements of Eloquent.
