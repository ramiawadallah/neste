...
class InstallCommand extends Command {
   ...
   * @var string
   */
  protected $description = 'Scaffolds a new migration and model suitable for Neste.';

  /**
   * Migration generator instance
   *
   * @var Neste\Generators\MigrationGenerator
   */
  protected $migrator;
   ...
   *
   * @var Neste\Generators\ModelGenerator
   */
  protected $modeler;
